...
export class ProjectDescription {
  ...
  static create(value: string | null | undefined): ProjectDescription {
    ...
    ProjectDescription.validate(normalizedValue);
    return new ProjectDescription(normalizedValue);
  }
   ...
   */
  static reconstruct(value: string | null): ProjectDescription {
  ...
  private static validate(value: string | null): void {
    if (value && value.length > ProjectDescription.MAX_LENGTH) {
      throw domainValidationError("PROJECT_DESCRIPTION_TOO_LONG");
    }
  }
